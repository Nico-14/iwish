    ...
    <>
      <header className={styles.header}>
        ...
        <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top" className={styles['paypal-donate']}>
          ...
          <input type="submit" value="Help with a donation" className={styles['header__button']}></input>
        </form>
        <button className={styles['header__button'] + ' ' + styles['share-button']} onClick={() => setShowShare(true)}>Share</button>
      </header>
      {showShare ?
